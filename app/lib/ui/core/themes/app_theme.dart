...
ThemeData _buildTheme({
  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
      bodyLarge: typo.mono.copyWith(fontSize: 15.0, color: colors.text),
      bodyMedium: typo.mono.copyWith(fontSize: 14.5, color: colors.text),
      bodySmall: typo.monoSmall.copyWith(fontSize: 12.0, color: colors.muted),
